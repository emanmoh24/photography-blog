      ...
      <header className="text-center pt-40 pb-20 bg-neutral-950 bg-[linear-gradient(to_right,#ffffff0d_1px,transparent_1px),linear-gradient(to_bottom,#ffffff0d_1px,transparent_1px)] bg-[size:60px_60px]">
        <div className="container mx-auto">
          <div>
            ...
            <h1 className="text-white font-bold lg:text-6xl py-6 min-[375px]:text-4xl md:text-5xl">
              مهمتنا هي{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-amber-500">
                الإعلام والإلهام
              </span>
            </h1>
            <p className="text-xl text-neutral-500 lg:w-3/5 mx-auto pb-12 min-[375px]:w-[90%]">
          ...
          <div className="grid min-[375px]:grid-cols-2 min-[375px]:w-[90%] md:grid-cols-4 mx-auto w-3/4 gap-5">
