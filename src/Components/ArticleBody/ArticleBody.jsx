        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-3 w-[95%] mx-auto text-white gap-12">
                  ...
                  {sections.map((section, index) => {
                    ...
                    return (
                      <React.Fragment key={index}>
                        ...
                        <dd className="text-lg text-neutral-400 pb-14 leading-relaxed">
                          {section.description}
                        </dd>
                      </React.Fragment>
                    );
                ...
                <div className="grid grid-cols-1 gap-4">
                  ...
                  <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-6 flex items-center gap-4">
                    ...
                    <div className="flex flex-col items-start">
                      ...
                      <span className="text-neutral-400 text-sm mt-3">
            ...
            <div className="col-span-1">
              <div className="sticky top-10 grid grid-cols-1 gap-4 ">
                <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-6">
                  <div className="flex items-center gap-3 mb-5">
                    <span className="text-lg text-orange-500 border flex items-center justify-center rounded-lg p-2 bg-[#231309] border-[#662C06]">
